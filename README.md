...
|:----------------------------------------------------------------------------------------------------------------------------------:|
| ![ScreenShot](https://github.com/unchil/ComposeDataGrid/blob/701400ee6ff81fcf16998eec2c0da7c9749f5b8a/screenshot/allPlatforms.png) | 
...
kotlin {
    sourceSets {
        commonMain.dependencies {
            ...
            implementation("com.github.unchil:un7datagrid:0.2.4-2")
        }
    }
}
```
