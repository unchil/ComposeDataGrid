...
/**
 * Renders an individual data row in the grid.
 * Changes the background color based on selection status and handles click, double-click, and long-click events.
 *
 * @param isVisibleRowNum Whether to display row numbers.
 * @param dataIndex The data index of the current row.
 * @param pagingData The data map to display on the current page.
 * @param modifier The modifier to apply to the row (including a click handler).
 */
@Composable
